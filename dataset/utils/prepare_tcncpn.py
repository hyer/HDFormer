...
pred_path = join(base_path, 'tcn_cpn_20484g.npz')
...
save_dir = 'vis_res/stat_mix_tcncpn'
...
np.savez_compressed(join(save_dir, 'tcn_cpn.npz'), data=structured_2d_pred, center_data_stat=center_data_stat,
