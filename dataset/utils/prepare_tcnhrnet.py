...
pred_path = join(base_path, 'tcn_hrnet.npz')
...
save_dir = 'vis_res/stat_mix_tcnhrnet'
...
np.savez_compressed(join(save_dir, 'tcn_hrnet.npz'), data=structured_2d_pred, center_data_stat=center_data_stat,
